...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding ManyToManyField 'Discount.valid_categories'
        db.create_table('product_discount_valid_categories', (
    ...
    def backwards(self, orm):
        ...
        # Dropping ManyToManyField 'Discount.valid_categories'
        db.delete_table('product_discount_valid_categories')
